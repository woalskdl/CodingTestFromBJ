...
public class P4991_answer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            distance = new int[nodeList.size()][nodeList.size()];
...
//            System.out.println("Node >> " + next.y + " : " + next.x);
//            System.out.println("Map[y][x] >> " + map[next.y][next.x]);
    ...
    private static boolean inArea(int y, int x) {
        return y >= 0 && y < h && x >= 0 && x < w && map[y][x] != 'x';
    }
}
